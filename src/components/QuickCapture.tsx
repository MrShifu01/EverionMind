...
import { useQuickCaptureVoice } from "../hooks/useQuickCaptureVoice";
...
export default function QuickCapture({
  ...
  const { listening, startVoice } = useQuickCaptureVoice({
    onTranscript: (t) => setText((prev) => (prev ? `${prev} ${t}` : t)),
    onStatus: (s) => setStatus(s as CaptureStatus | null),
