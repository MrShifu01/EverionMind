...
|---|---|---|---|---|---|
| **Everion** | TBD | Yes (web) | Yes (chat) | Yes (secrets vault) | TBD |
| Mem.ai | $12/mo | **No** | Yes | No | 25 notes/mo |
| Obsidian | $4/mo (sync) | Yes (buggy) | Via plugins only | No (local only) | Yes (full) |
...
- **Platform:** Web, macOS, iOS — **no Android app at all**
- **Differentiator:** AI-organized with zero manual structure — no folders, no tags. Mem Chat lets you query your entire note library conversationally. Mem 2.0 (Oct 2025) added offline support and smarter voice capture.
...
- **Notable:** Auto-linking of notes without any manual input — entirely model-driven organization

---

### 2. Rewind AI / Limitless (now Meta-acquired — effectively defunct)
- **Pricing:** Was $99 hardware + $20/mo. Post-Meta acquisition (Dec 2025): free for 1 year, then folded into Meta ecosystem
- **Platform:** Was macOS + iOS/Android companion + hardware pendant. Now defunct as standalone.
- **Differentiator:** Ambient total-recall — the Pendant recorded all in-person conversations; the desktop app recorded every meeting, screen, and audio. Full timeline queryable by AI ("what happened last Tuesday at 3pm?").
- **Weaknesses:** Product is dead. Privacy backlash at Meta acquisition was immediate. Was $339/year first year.
- **Notable:** Proved massive consumer demand for ambient/passive capture. The space is now wide open.

---

### 3. Notion AI
- **Pricing:** Free (limited AI trial) · Plus $10/user/mo · **Business $15/user/mo (full AI)** · Enterprise custom
- **Platform:** Web, iOS, Android, macOS, Windows
- **Differentiator:** Workspace + relational databases + AI Agents (Sept 2025). Agents can autonomously work across hundreds of pages for up to 20 minutes. Cross-model: GPT-4.1 and Claude 3.7 Sonnet both available.
...
- **Notable:** AI Agents that operate autonomously across your entire workspace — most capable non-chat AI feature in the category

---

### 4. Obsidian
- **Pricing:** Free for personal use · Sync $4/mo · Publish $8/mo
- **Platform:** Windows, macOS, Linux, iOS, Android (buggy on Android — loading can exceed 1 minute)
- **Differentiator:** Local-first Markdown vault, 1,400+ community plugins. AI via plugins (Smart Connections, Smart Composer) including local models via Ollama — zero cloud dependency.
- **Weaknesses:** Android sync is broken/unreliable. High setup friction (users spend hours on config). No native AI — requires plugin setup. No collaboration.
...
- **Differentiator:** Unified read-later inbox for every format (articles, PDFs, EPUBs, newsletters, RSS, YouTube, Twitter threads). "Ghostreader" AI reads alongside you, not just summarizes after. Spaced-repetition resurfacing of highlights to Obsidian, Notion, Roam, and more.
...
- **Notable:** Contextual resurface while writing — surfaces past notes relevant to what you're currently typing, in real time

---

### 7. Capacities
- **Pricing:** Free (unlimited notes, 5 GB) · Pro $9.99/mo · Believer $12.49/mo
- **Platform:** Web, desktop, iOS, Android (buggy on Android — words disappear randomly)
- **Differentiator:** Typed object model. Instead of flat notes, every item is a typed object (Book, Person, Project, Event) with structured properties. Creates a typed personal knowledge graph.
...
- **Weaknesses:** No offline mode. Pro at $16/mo is expensive.
...
- **Differentiator:** Premium journaling with richest media support (voice, video, photo, handwriting). On-This-Day resurfacing. Print physical books from your journal. Gold tier: AI Daily Chat (conversational journaling assistant).
...
- **Differentiator:** End-to-end encrypted, peer-to-peer, local-first. Uses a 12-word recovery phrase (crypto-wallet model). Object-based like Capacities. Nobody can read your data — not even Anytype.
- **Weaknesses:** Steep object/type learning curve. AI features less mature.
- **Notable:** P2P sync — no central cloud server holds your data. The only mainstream PKM with true data sovereignty.
...
### 12. Apple Notes / Google Keep (Baseline)
- **Pricing:** Free (5 GB iCloud shared / 15 GB Google account shared)
- **Platform:** Apple Notes: iOS/macOS only. Google Keep: cross-platform including Android/Windows.
...
- **Notable:** Apple Notes document scanning on mobile is best-in-class. Google Keep image OCR.
...
1. **Pricing creep + AI gating** — Notion's move to lock AI behind $15/user Business plan (May 2025) generated the category's biggest backlash of the year. Users are exhausted by subscription stacking.
2. **No Android / weak Android** — Mem has no Android. Obsidian Android sync is broken. Capacities Android is buggy. Huge underserved market.
...
5. **Privacy concerns with AI** — Meta acquisition of Limitless under Meta ToS caused immediate user exodus. Read AI and Notion AI both received pushback for opaque data policies.
6. **Slow mobile performance** — Readwise Reader, Obsidian Android, Capacities mobile all cited for lag.
...
- **Mem's missing Android app** — large addressable market of Android users who want AI-organized notes
